...
socket.on('disconnect', () => {
    // Tento alert je jednoduché řešení. V produkční aplikaci by se to řešilo elegantněji.
    alert("Spojení se serverem Avalon bylo přerušeno. Stránka bude obnovena.");
    location.reload();
});
